...
最新设备和制品状态以文档末尾的 2026-09-20 交接增量为准：代码验证基线为 `20424421d547cb872bcbe45aaf8e4a3b2f3f03a6`，当前 Debug APK SHA-256 为 `2436C5F4AFF4EB8CA46A464E9733968FA256A39B29FA3137824C66211476820`；Android 当前只有独立模拟器，Windows 已补齐隔离解压版三轮恢复和 CI artifact。早期两台真机和旧制品记录保留为历史证据，不自动扩展到当前 APK 或发布门禁。
