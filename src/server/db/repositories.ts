...
const AUDIT_METADATA_KEYS = new Set(['runId', 'transferId', 'accountId', 'deviceId', 'vaultId', 'action', 'resolution', 'reason', 'status', 'targetCount', 'successCount', 'failureCount', 'cancelledCount', 'interruptedCount', 'anomalyCount', 'truncatedCount', 'durationMs', 'revision', 'keyVersion']);
