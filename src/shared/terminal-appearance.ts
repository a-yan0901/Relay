...
export const BUILTIN_TERMINAL_PROFILES: readonly TerminalProfile[] = Object.freeze([
  ...
  builtin('termius', 'Termius 经典', { background: '#141729', foreground: '#21b568', cursor: '#21b568', black: '#141729', brightBlack: '#3a3f52', blue: '#2092f6', brightBlue: '#56a8ff', green: '#21b568', brightGreen: '#44d98b', red: '#f24e50', brightRed: '#ff6b6d', yellow: '#d9b44a', brightYellow: '#f0d36b', cyan: '#28c7a0', brightCyan: '#5de6c5', magenta: '#d24f9c', brightMagenta: '#f06bc0', white: '#d8dbea', brightWhite: '#ffffff' }),
