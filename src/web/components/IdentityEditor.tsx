  ...
  return (
    <section className="identity-editor" aria-labelledby="identity-editor-title">
      ...
      <div className="form-grid">
        ...
        <div className="field"><label htmlFor="identity-username">身份用户名</label><input id="identity-username" value={username} onChange={(event) => setUsername(event.target.value)} autoComplete="off" /></div>
